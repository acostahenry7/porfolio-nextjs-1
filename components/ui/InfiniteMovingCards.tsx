  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border 1border-b-0 border-slate-800  p-5 md:p-16 md:w-[60vw]"
            style={{
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <div className="me-3 ">
                  <img
                    ...
                    alt="profile"
                    className="size-14 rounded-full object-none"
                  />
                </div>
